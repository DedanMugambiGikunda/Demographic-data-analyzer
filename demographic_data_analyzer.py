...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_above_50k = len(df[((df["Education"] == "Bachelors") | (df["education"] == "Masters") | (df["education"] == "Doctorate")) & (df["salary"] == ">50")])

    lower_education = len(df[((df["Education"] != "Bachelors") & (df["education"] != "Masters") & (df["education"] != "Doctorate"))])
    lower_education_above_50k = len(df[((df["Education"] == "Bachelors") | (df["education"] == "Masters") | (df["education"] == "Doctorate")) & (df["salary"] == ">50")])
    ...
    num_min_workers = len(df[(df["hours-per-week"] == 1)])  #1 cause 1 hour a week
    ...
    highest_earning_country_percentage = df1

    # Identify the most popular occupation for those who earn >50K in India.
    occupation_above_50 = df[(df["salary"] == ">50k") & (["native-country"] == "india").]
